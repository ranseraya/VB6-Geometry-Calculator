VERSION 5.00
Begin VB.Form frmSegitiga 
   Caption         =   "Kalkulator Luas Segitiga"
   ClientHeight    =   4170
   ClientLeft      =   60
   ClientTop       =   405
   ClientWidth     =   6750
   ...
   End
   Begin VB.Label alas 
      Caption         =   "Masukkan Panjang Segitiga"
      Height          =   495
      Index           =   1
      Left            =   240
      TabIndex        =   2
...
Private Sub btnHitung_Click()
    ...
    HasilLuas = Kalkulator.LSegitiga(panjang, tinggi)
