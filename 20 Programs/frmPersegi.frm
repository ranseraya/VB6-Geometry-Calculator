VERSION 5.00
Begin VB.Form frmPersegi 
   Caption         =   "Kalkulator Luas Persegi"
   ClientHeight    =   3300
   ClientLeft      =   60
   ClientTop       =   405
   ClientWidth     =   6570
...
Private Sub btnHitung_Click()
   ...
   If Sisi < 0 Then
    ...
    HasilLuas = Kalkulator.LPersegi(Sisi)
