VERSION 5.00
Begin VB.Form frmJajarGenjang 
   Caption         =   "Kalkulator Luas Jajar Genjang"
   ClientHeight    =   4710
   ClientLeft      =   60
   ClientTop       =   405
   ClientWidth     =   6750
   ...
   Begin VB.Label labelJudul 
      Alignment       =   2  'Center
      AutoSize        =   -1  'True
      Caption         =   "Hitung Luas Jajar Genjang"
      BeginProperty Font 
         Name            =   "MS Sans Serif"
         Size            =   12
         Charset         =   0
   ...
   End
End
Attribute VB_Name = "frmJajarGenjang"
...
Private Sub btnHitung_Click()
    ...
    HasilLuas = Kalkulator.LJajarGenjang(panjang, lebar)
