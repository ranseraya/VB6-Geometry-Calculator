VERSION 5.00
Begin VB.Form frmBelahKetupat 
   Caption         =   "Kalkulator Luas Belah Ketupat"
   ClientHeight    =   4185
   ClientLeft      =   60
   ClientTop       =   405
   ClientWidth     =   6765
   ...
   Begin VB.Label labelJudul 
      Alignment       =   2  'Center
      AutoSize        =   -1  'True
      Caption         =   "Hitung Luas Belah Ketupat"
      BeginProperty Font 
         Name            =   "MS Sans Serif"
         Size            =   12
         Charset         =   0
   ...
   End
End
Attribute VB_Name = "frmBelahKetupat"
...
Private Sub btnHitung_Click()
    ...
    HasilLuas = Kalkulator.LBelahKetupat(tinggi, panjang)
