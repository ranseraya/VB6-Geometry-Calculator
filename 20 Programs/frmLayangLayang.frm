VERSION 5.00
Begin VB.Form frmLayangLayang 
   Caption         =   "Kalkulator Luas Layang-Layang"
   ClientHeight    =   4125
   ClientLeft      =   60
   ClientTop       =   405
   ClientWidth     =   6675
   ...
   End
   Begin VB.Label alas 
      Caption         =   "Masukkan Panjang Diagonal 2"
      Height          =   495
      Index           =   1
      Left            =   240
      TabIndex        =   2
   ...
   Begin VB.Label tinggi 
      Caption         =   "Masukkan Panjang Diagonal 1"
      Height          =   495
      Index           =   0
      Left            =   240
      TabIndex        =   1
   ...
   Begin VB.Label labelJudul 
      Alignment       =   2  'Center
      AutoSize        =   -1  'True
      Caption         =   "Hitung Luas Layang-layang"
      BeginProperty Font 
         Name            =   "MS Sans Serif"
         Size            =   12
         Charset         =   0
   ...
   End
End
Attribute VB_Name = "frmLayangLayang"
...
Private Sub btnHitung_Click()
    ...
    If Not IsNumeric(txtPanjang.Text) Or Not IsNumeric(txtTinggi.Text) Then
    ...
    If panjang < 0 Or tinggi < 0 Then
        MsgBox "Nilai tidak boleh negatif!", vbCritical, "Input Salah"
        Exit Sub
    End If
    
    HasilLuas = Kalkulator.LLayangLayang(tinggi, panjang)
